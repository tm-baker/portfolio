  ...
  return (
    ...
    <div className="flex relative">
      <img
        ...
        src={props.image}
      />
      <div className="px-4 py-10 absolute z-10 h-full w-full border-4 border-white bg-tealish opacity-0 hover:opacity-100">
        <div className="pt-0 lg:pt-16 align-middle">
          ...
          <p className="leading-relaxed text-white">{props.description}</p>
        </div>
      </div>
    </div>
  </a>
