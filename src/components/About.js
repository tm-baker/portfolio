    ...
    <section id="about" className="flex flex-col h-screen">
      <div className="container flex m-auto md:flex-row items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 lg:pl-24 md:pr-16 -mt-40 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font lg:text-7xl text-4xl mb-4 font-medium text-black" data-aos="fade" id="helloWorld" data-aos-easing="linear">
          ...
          I'm focused on developing a financial management system at <a href='https://www.cmpa-acpm.ca/en/home' className="text-tealish font-medium hover:text-white">The Canadian Medical Protective Association</a>.
          </p>
          <div className="flex justify-center" data-aos="fade" data-aos-delay="2000">
            <a
              href="#contact"
              className="inline-flex text-white font-medium bg-tealish border-0 py-2 px-6 focus:outline-none hover:bg-tealish rounded text-lg">
              Contact Me
            </a>
            <a
              href="#experience"
              className="ml-4 inline-flex font-medium text-tealish bg-white border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 hover:text-white rounded text-lg">
              Learn More
            </a>
          </div>
        </div>
